// VALIDIERTE VERSION: Phoenix Edition v4.8.4 (Preloader-Timing-Fix)
...
// KORREKTUR: Nutzt das 'window.load'-Event statt 'DOMContentLoaded' für eine zuverlässigere Preloader-Funktion.
...
class PhoenixDossier {
    ...
    hidePreloader() {
        // Diese Methode stellt sicher, dass der Preloader am Anfang sichtbar ist.
        // Das eigentliche Ausblenden geschieht im 'finally'-Block der init() Methode.
...
// KORREKTUR: Das Event wird auf 'load' geändert, um sicherzustellen, dass alle Ressourcen geladen sind.
